...
{#if page.status === 404}
<div class="grid h-[calc(100vh-64px)] w-full place-items-center bg-[#101828] px-5 py-16 text-white">
    <div class="max-w-md w-full text-center">
        ...
        <a 
            href="/"
            class="inline-block bg-gray-900 hover:bg-gray-800 text-white py-3 px-6 rounded-lg transition-colors font-medium"
        >
            Return to Home
        </a>
    </div>
