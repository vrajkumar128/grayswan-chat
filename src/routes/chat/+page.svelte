...
{#if loading}
    <div
        class="flex flex-col justify-center items-center h-screen bg-[#101828] text-white"
    >
...
{:else}
    <div
        class="flex flex-col justify-end items-center h-screen bg-[#101828] text-white"
    >
        <div class="flex flex-col h-[92.5%] w-full max-w-4xl mx-auto px-4">
